...
// create category
router.post('/addCategory', verifyTokenAndAdmin, controllers.createCategory)
...
// UPDATE
router.put('/updateCategory/:id', verifyTokenAndAdmin, controllers.updateCategory)
// DELETE
router.delete('/deleteCategory/:id', verifyTokenAndAdmin, controllers.deleteCategory)
